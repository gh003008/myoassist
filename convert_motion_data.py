...
CONFIG = {
    ...
    'output_file_2d': r"rl_train\reference_data\S004_trial01_08mps_2D.npz",
    'output_file_3d': r"rl_train\reference_data\S004_trial01_08mps_3D.npz",
    ...
    'opensim_mapping': {
        ...
        # Hip rotations (X=adduction, Y=flexion, Z=rotation)
        'hip_adduction_r': 'hip_r_0',
        'hip_flexion_r': 'hip_r_1',
        'hip_rotation_r': 'hip_r_2',
        'hip_adduction_l': 'hip_l_0',
        'hip_flexion_l': 'hip_l_1',
        'hip_rotation_l': 'hip_l_2',

...
register_env_myoassist(id='myoAssistLeg-v0',
        entry_point='rl_train.envs.myoassist_leg_base:MyoAssistLegBase',
        max_episode_steps=1000,
        kwargs={},
    )
register_env_myoassist(id='myoAssistLegImitation-v0',
        entry_point='rl_train.envs.myoassist_leg_imitation:MyoAssistLegImitation',
        max_episode_steps=1000,
        kwargs={},
    )
register_env_myoassist(id='myoAssistLegImitationExo-v0',
        entry_point='rl_train.envs.myoassist_leg_imitation_exo:MyoAssistLegImitationExo',
        max_episode_steps=1000,
        kwargs={},
    )
